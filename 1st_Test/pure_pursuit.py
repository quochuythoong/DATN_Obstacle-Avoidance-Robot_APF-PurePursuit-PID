...
###############################################################################
def pure_pursuit_main(corners, global_path, frame, last_angle, last_end_point_arrow, flag_client_control, aruco_path, flag_initialize_direction, goal_set_points):
