...
openCV.initialize_window(
    ...
    mouse_callback,
    (clicked_points, reset_button_pos, start_button_pos, button_width, button_height, frame_height, start_pressed, interpolated_waypoints, latest_waypoint, flag_clicked_point_added)
)
